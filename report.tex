...
\section*{References}
\begin{enumerate}
    \item El Romeh, A., Mirjalili, S., \& Šnel, V. (2025). Dholes-Inspired Optimization (DIO). \textit{Cluster Computing} (Springer). DOI: 10.1007/s10586-025-05543-2. Open-source: \url{https://github.com/AlyromehDholes-Inspired-Optimization-DIO}, MathWorks File Exchange.
