...
add_bullet_points(tf, [
    ...
    "  - DIO-optimized (598 features): 83.6% accuracy",
    "  - Baseline (all 2048 features): 80.8% accuracy",
    "  - Seemed like +2.8% improvement with 71% feature reduction",
    "",
...
add_bullet_points(tf, [
    ...
    "  - Single-run results are deceptive (83.6% vs 80.8% looked good)",
